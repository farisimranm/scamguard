...
class Leopard {
    ...
    constructor(accessKey, options = {}) {
        ...
        const { modelPath = path.resolve(__dirname, DEFAULT_MODEL_PATH), libraryPath = (0, platforms_1.getSystemLibraryPath)(), enableAutomaticPunctuation = false, } = options;
